...
function facetsTemplateDesktop(
  ...
  function facetsTemplateMobile(
    ...
    showMoreLessMobile: (e: React.MouseEvent<HTMLDivElement, MouseEvent>, data: IFacetData) => void,
    openOverlay: () => void,
    closeOverlay: () => void,
    unselectAll: () => void
  ) {
        ...
        <div className="searchstax-facets-pills-container">
          ...
          >
            <div className="searchstax-facets-mobile-overlay-header">
              <div className="searchstax-facets-mobile-overlay-header-title">Filter By</div>
              <div
                  ...
                  >
                    <div>
                      ...
                      <div className="searchstax-facet-values-container">
                        ...
                        <div className="searchstax-facet-show-more-container" v-if="facet.hasMoreFacets">
                          <div
                            className="searchstax-facet-show-more-container"
                            onClick={(e) => {
